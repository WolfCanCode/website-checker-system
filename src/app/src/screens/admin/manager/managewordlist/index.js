...
export default class managewordlist extends Component {
    ...
    state = { addModal: false, isLoading: false, listWord: [], word: "", type: "", isDisable: true, addLoading: false, topicList: [], topicSelected: [] }
                    ...
                    <Segment.Group horizontal style={{ maxHeight: '63vh', overflow: "auto" }}>
                        <Segment basic loading={this.state.isLoading}>
                            <Table singleLine unstackable>
                                ...
                                <Table.Body>
                                    {this.state.listWord.length === 0 ? "Please add warning word for every topic" : this.state.listWord}
                                </Table.Body>
                            </Table>
                        </Segment>
