...
export default class TableRow extends Component {
    ...
    render() {
        ...
        return (<Table.Row style={{ background: "#ffebee" }}>
            <Table.Cell style={{ width: '300px', whiteSpace: 'normal', wordBreak: 'break-all', color: '#ef5350', fontWeight: 'bold' }}>{this.props.messages.split('WCSLINK')[0]}<br />@<a href={this.props.messages.split('WCSLINK')[1].split(" ")[0]}>{this.props.messages.split('WCSLINK')[1]}</a></Table.Cell>
            <Table.Cell style={{ width: '100px', whiteSpace: 'normal', wordBreak: 'break-all' }}><Label style={{ fontSize: '14px' }} color={"red"} horizontal>{this.props.type}</Label></Table.Cell>
