...
import { Segment, Button, Table, Icon, Input, Label, Modal, Transition } from 'semantic-ui-react';
...
export default class TableRow extends Component {
    ...
    state = {wrongWord:this.props.word, excerpt:this.props.excerpt, page : this.props.page,
